...
El la Figura \ref{Implementación lógica del subsistema 1} anterior se muestra un diagrama lógico que describe al subsistema 1. Este se basa en tomar el MSB del código binario como el MSB del código de gray
