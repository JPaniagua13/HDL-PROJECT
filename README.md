...
&nbsp;&nbsp;&nbsp;&nbsp; Para los miembros cuyos problemas de instalación persistieron se tomó la decisión de utilizar VMWare para realizar las pruebas iniciales del programa. El hacer uso de este otro problema ocurrió. La interfaz de Vivado se trababa a cortos plazos de tiempo lo que resultaba en estar reiniciando el computador una y otra vez.
